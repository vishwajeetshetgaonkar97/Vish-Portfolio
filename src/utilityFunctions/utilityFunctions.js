...
const projectsList = [
  ...
  {
    id: 2,
    name: "Transforming Sports Production with the Studio Dashboard",
    description:
      "Designed and developed a user-centric Studio Dashboard for SportVot, enabling seamless cloud-based sports production and streaming. The platform supported over 300K games, 350K athlete profiles, and scaled operations to 20+ countries.",
    image: "/work/svStudio/mockup.png",
    link: "/projects/SvStudioDashboard",
    category: "D",
    tags: "UI, UX, Dashboard, Product, Web, Cloud Studio",
  },
  {
    id: 1,
